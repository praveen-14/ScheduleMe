...
<?php
    ...
    if(Developer::where('id',Auth::user()->id)->get()!=null){?>
        <li class="treeview">
    ...
    <?php }
    if(ProjectManager::where('id',Auth::user()->id)->get()!=null){?>
        <li class="treeview">
            <a href="{{ url('/projectManagerHome') }}">
                <i class="fa fa-dashboard"></i> <span> Manage Projects</span>
                <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
            </a>
        ...
        <li class="treeview">
            <a href="{{ url('/createProject') }}">
                <i class="fa fa-dashboard"></i> <span> Start New Project</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
